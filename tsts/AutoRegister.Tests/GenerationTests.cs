   ...
   static Task RunGeneratorAsync(string sourceInput, string expectedSourceOutput) =>
      new GeneratorTest
      {
         ...
         TestState =
         {
            ...
            GeneratedSources =
            {
               (typeof(SourceGeneratorAdapter<Generator>), "AutoRegister.Attributes.g.cs",
                AttributeSourceOutput),
               (typeof(SourceGeneratorAdapter<Generator>), "AutoRegister.ServiceCollectionExtension.g.cs",
